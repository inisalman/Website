      ...
      <div className="container">
        <div className="content">
          <div className="details">
            <div className="short">
              <h3>
                I'm Salman <img className="svg" src="img/svg/hi.svg" alt="" />
              </h3>
              <span className="job">Registered Nurse and Computer Enthusiast.</span>
            </div>
            <div className="text">
              <p>
                {`I'm`} Currently working for RSUP Persahabatan as Professional Nurse, based in Jakarta. and {`I'm`} very
        ...
        <div className="orido_tm_follow">
          ...
          <ul>
            <li>
              <a href="https://www.linkedin.com/in/salman-al-farisi-b942a3143/">
            ...
            <li>
              <a href="https://www.instagram.com/inisalman">
                <img
                  className="svg"
